...
/*
        ...
        */
        ...
        function check_events(mes, ano){
            ...
            var ultimoDiaMes = ultimoDia(parseInt(mes),ano);
            ...
            PdateStart = '01/' + mes + "/" + ano;
            PdateEnd = ultimoDiaMes + "/" + mes + "/" + ano;
        ...
        function marcarEventos(mes, ano){
            ...
            for(var i=0; i< events.length; i++) {
                ...
                var eventDay = eventDate.substring(6,8);
                var eventMonth = eventDate.substring(4,6);
                ...
                var eventString = parseInt(eventDay) + "_" + parseInt(eventMonth) + "_" + eventYear;

                var divID = id_calendari + '_' + eventString;

                console.log("DIV:" + divID);


                $('#' + divID).addClass('event');

                $('#' + divID).css('background','blue');

               

                //var eventDate = ano + fmes + fdia;
                //if (events[i]['eventDate'] == eventDate) 
